    ...
    protected SourceLoader<IdType, RoleStruct> createMultipleRoleLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, RoleStruct> result = () -> {
                ...
                map.put(IdBuilder.id(1), StructBuilder.newRoleStruct(1, defaultAId, null, NativeRoleEnum.ALL_PERMISSION.getCode(), true, NativeRoleEnum.ALL_PERMISSION.getCode(), true, null, 1, null, NativeRoleEnum.ALL_PERMISSION.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(2), StructBuilder.newRoleStruct(2, defaultAId, null, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), true, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), true, null, 1, null, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(3), StructBuilder.newRoleStruct(3, defaultAId, 10, NativeRoleEnum.TENANT_MAINTAINER.getCode(), true, NativeRoleEnum.TENANT_MAINTAINER.getCode(), true, null, 1, null, NativeRoleEnum.TENANT_MAINTAINER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(4), StructBuilder.newRoleStruct(4, defaultAId, 10, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), true, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), true, null, 1, null, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), 1, new Date(), 1, new Date(), 1));
