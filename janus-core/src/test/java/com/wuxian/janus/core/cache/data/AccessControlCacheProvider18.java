    ...
    protected SourceLoader<IdType, OuterObjectStruct> createOuterObjectLoader(IdType outerObjectTypeId) {
        if (StrictUtils.equals(outerObjectTypeId, IdBuilder.id(outerObjectTypeId1))) {
            SourceLoader<IdType, OuterObjectStruct> result = () -> {
                ...
                map.put(IdBuilder.id(10), StructBuilder.newOuterObjectStruct(10, outerObjectTypeId1, "EMS001", "ref100", "销售", null, 1, new Date(), 1, new Date()));
                return map;
            };
            return result;
            ...
            SourceLoader<IdType, OuterObjectStruct> result = () -> {
                Map<IdType, OuterObjectStruct> map = new HashMap<>();
                map.put(IdBuilder.id(11), StructBuilder.newOuterObjectStruct(11, outerObjectTypeId2, "ORG001", "ref8001", "ORG001", null, 1, new Date(), 1, new Date()));
                map.put(IdBuilder.id(12), StructBuilder.newOuterObjectStruct(12, outerObjectTypeId2, "ORG002", "ref8002", "ORG002", null, 1, new Date(), 1, new Date()));
                return map;
            };
            return result;
        }
