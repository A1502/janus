...
public class AccessControlCacheProvider05 extends BaseAccessControlCacheProvider {
    ...
    protected SourceLoader<IdType, UserGroupStruct> createUserGroupLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, UserGroupStruct> result = () -> {
                ...
                map.put(IdBuilder.id(3), StructBuilder.newUserGroupStruct(3, defaultAId, defaultTId, "code1", "name1", true, "des1", 1, 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(4), StructBuilder.newUserGroupStruct(4, defaultAId, defaultTId, "code2", "name2", true, "des2", 2, 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(5), StructBuilder.newUserGroupStruct(5, defaultAId, defaultTId, "code3", "name3", true, "des3", 3, 1, new Date(), 1, new Date(), 1));
                return map;
            };
            return result;
        }
    ...
    protected SourceLoader<IdType, RoleUserGroupXStruct> createSingleRoleUserGroupXLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, RoleUserGroupXStruct> result = () -> {
                ...
                map.put(IdBuilder.id(1), StructBuilder.newRoleUserGroupXStruct(1, 1, 3, true, true, true, true, false, false, false, false, false, false, 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(2), StructBuilder.newRoleUserGroupXStruct(2, 2, 4, true, false, true, true, false, false, false, false, false, false, 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(3), StructBuilder.newRoleUserGroupXStruct(3, 4, 4, true, true, true, true, false, false, false, false, false, false, 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(4), StructBuilder.newRoleUserGroupXStruct(4, 2, 5, true, true, true, true, false, false, false, false, false, false, 1, new Date(), 1, new Date(), 1));
                return map;
            };
            return result;
        }
    ...
    protected SourceLoader<IdType, OuterObjectStruct> createOuterObjectLoader(IdType outerObjectTypeId) {
        SourceLoader<IdType, OuterObjectStruct> result = () -> {
            ...
            map.put(IdBuilder.id(2), StructBuilder.newOuterObjectStruct(2, 1, "EMS002", "101", "HR", null,1, new Date(), 1, new Date()));
            return map;
        };
        return result;
    }
