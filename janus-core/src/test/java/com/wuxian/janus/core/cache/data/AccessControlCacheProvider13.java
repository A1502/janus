    ...
    protected SourceLoader<IdType, UserGroupEntity> createUserGroupLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, UserGroupEntity> result = () -> {
                ...
                map.put(IdBuilder.id(1), EntityBuilder.newUserGroupEntity(1, defaultAId, null, NativeUserGroupEnum.APPLICATION_ADMIN.getCode(), NativeUserGroupEnum.APPLICATION_ADMIN.getCode(), true, null, null, 1, new Date(), 1, new Date(), 1));
                ...
                map.put(IdBuilder.id(5), EntityBuilder.newUserGroupEntity(5, defaultAId, defaultTId, "code5", "name5", true, "des5", 20, 1, new Date(), 1, new Date(), 1));
    ...
    protected SourceLoader<IdType, RoleEntity> createMultipleRoleLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, RoleEntity> result = () -> {
                ...
                map.put(IdBuilder.id(1), EntityBuilder.newRoleEntity(1, defaultAId, null, NativeRoleEnum.ALL_PERMISSION.getCode(), true, NativeRoleEnum.ALL_PERMISSION.getCode(), true, null, null, null, NativeRoleEnum.ALL_PERMISSION.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(2), EntityBuilder.newRoleEntity(2, defaultAId, null, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), true, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), true, null, null, null, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(3), EntityBuilder.newRoleEntity(3, defaultAId, defaultTId, NativeRoleEnum.TENANT_MAINTAINER.getCode(), true, NativeRoleEnum.TENANT_MAINTAINER.getCode(), true, null, null, null, NativeRoleEnum.TENANT_MAINTAINER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(4), EntityBuilder.newRoleEntity(4, defaultAId, defaultTId, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), true, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), true, null, null, null, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), 1, new Date(), 1, new Date(), 1));
