...
/*
    内置用户组ApplicationMaintainer得到2.5级的AllPermission角色--Multiple
    等号左边：OuterObject，UserGroup，Role
    等号右边：Permission，Role，user

*/
public class AccessControlCacheProvider13 extends BaseAccessControlCacheProvider {
    ...
    protected SourceLoader<IdType, UserGroupStruct> createUserGroupLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, UserGroupStruct> result = () -> {
                ...
                map.put(IdBuilder.id(1), StructBuilder.newUserGroupStruct(1, defaultAId, null, NativeUserGroupEnum.APPLICATION_ADMIN.getCode(), NativeUserGroupEnum.APPLICATION_ADMIN.getCode(), true, null, null, 1, new Date(), 1, new Date(), 1));
                ...
                map.put(IdBuilder.id(5), StructBuilder.newUserGroupStruct(5, defaultAId, defaultTId, "code5", "name5", true, "des5", 20, 1, new Date(), 1, new Date(), 1));
    ...
    protected SourceLoader<IdType, RoleStruct> createMultipleRoleLoader(ApplicationIdType applicationId, TenantIdType tenantId) {
        if (StrictUtils.equals(applicationId, IdBuilder.aId(defaultAId)) && StrictUtils.equals(tenantId, IdBuilder.tId(defaultTId))) {
            SourceLoader<IdType, RoleStruct> result = () -> {
                ...
                map.put(IdBuilder.id(1), StructBuilder.newRoleStruct(1, defaultAId, null, NativeRoleEnum.ALL_PERMISSION.getCode(), true, NativeRoleEnum.ALL_PERMISSION.getCode(), true, null, null, null, NativeRoleEnum.ALL_PERMISSION.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(2), StructBuilder.newRoleStruct(2, defaultAId, null, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), true, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), true, null, null, null, NativeRoleEnum.APPLICATION_MAINTAINER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(3), StructBuilder.newRoleStruct(3, defaultAId, defaultTId, NativeRoleEnum.TENANT_MAINTAINER.getCode(), true, NativeRoleEnum.TENANT_MAINTAINER.getCode(), true, null, null, null, NativeRoleEnum.TENANT_MAINTAINER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(4), StructBuilder.newRoleStruct(4, defaultAId, defaultTId, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), true, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), true, null, null, null, NativeRoleEnum.TENANT_DATA_OWNER.getCode(), 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(5), StructBuilder.newRoleStruct(5, defaultAId, defaultTId, "role5", true, "角色5", true, null, 5, "role5-outerObjectRemark", "role1-description", 1, new Date(), 1, new Date(), 1));
                map.put(IdBuilder.id(6), StructBuilder.newRoleStruct(6, defaultAId, defaultTId, "role6", true, "角色6", true, null, 6, "role6-outerObjectRemark", "role2-description", 1, new Date(), 1, new Date(), 1));
