        ...
        Application app1 = Application.byId("1")
                ...
                .addItem(
                        Tenant.byId("10")
                                ...
                                .addItem(
                                        UserGroup.byId("6", "stdUG", "AAAOutGroup", "ref100").addItem(Role.byId("5", "xxxRole")),
                                        UserGroup.byId("7", "bbbUG").addItem(
                                                Role.byId("6", "yyyRole"), Role.byId("7", "zzzRole"), User.byId("1")))
                                .addItem(
